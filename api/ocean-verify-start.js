// api/ocean-verify-start.js
// Same format as send-contact.js — Express handler
// Receives email → sends verification link via nodemailer
...
export default async function handler(req, res) {
  ...
  try {
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 48px 40px; background: #ffffff;">
          ...
          <p style="font-family: Arial, sans-serif; font-size: 12px; color: #aaa; text-align: center; margin: 0 0 8px;">
    ...
    console.error('ocean-verify-start error:', error);
