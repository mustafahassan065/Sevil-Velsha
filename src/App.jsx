    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-8 md:px-16 pb-16">
          <p className="text-white/90 text-xs italic tracking-wide mb-3 font-light">Ocean Couture, Documented</p>
          ...
          <div className="flex gap-6">
            <button className="text-white text-xs tracking-widest uppercase underline underline-offset-4 hover:text-white/70 transition-colors" onClick={scrollToEditorial}>
              View The First Edition
            </button>
            <button className="text-white text-xs tracking-widest uppercase underline underline-offset-4 hover:text-white/70 transition-colors" onClick={scrollToArchive}>
              Enter The Archive
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="px-10 md:px-16 py-16 flex flex-col justify-center space-y-8 bg-white">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-serif italic leading-tight" style={{ color: '#c9a84c' }}>Season 0:</h2>
              <h2 className="text-5xl md:text-6xl font-serif font-black text-black leading-tight">Seafoam Birth</h2>
            </div>
      ...
      <section style={{ backgroundColor: '#ede8df' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ minHeight: '520px' }}>
          <div className="flex flex-col justify-center space-y-6 px-8 md:px-16 py-20">
            ...
            <p className="text-xs tracking-widest uppercase text-gray-400">— Ocean Couture For A Living Planet</p>
          </div>
      ...
      <section className="py-24 px-6 md:px-16 lg:px-24 text-center" style={{ backgroundColor: '#ede8df' }}>
        ...
        <button className="text-xs tracking-widest uppercase border-b border-black pb-1 hover:opacity-60 transition-opacity" onClick={() => setShowAccessModal(true)}>
          Enter Academy
        </button>
      </section>
            ...
            <div key={index} className="group cursor-pointer" onClick={() => setShowAccessModal(true)}>
              <div className="overflow-hidden bg-gray-200 mb-4 relative" style={{ aspectRatio: '4/3.5' }}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: 'rgba(190,158,80,0.82)' }}>
