...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ── SEARCH MODAL ── */}
      {showSearch && (
        <div className="fixed inset-0 z-[100] bg-black/90 flex items-start justify-center pt-32 p-6" onClick={() => { setShowSearch(false); setSearchQuery(''); }}>
          <div className="w-full max-w-xl" onClick={e => e.stopPropagation()}>
            <div className="flex items-center gap-4 border-b border-white/40 pb-4 mb-8">
              <input
                ...
                className="flex-1 text-white text-lg bg-transparent focus:outline-none placeholder-white/40"
                style={{ letterSpacing: '0.05em' }}
              />
              <button onClick={() => { setShowSearch(false); setSearchQuery(''); }} className="text-white/60 text-xs tracking-widest uppercase">✕</button>
            </div>
      ...
      {/* ── ACCESS MODAL ── */}
      {showAccessModal && (
        <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-6" onClick={closeModal}>
...
>
  <img 
    src="/images/logo.png" 
    alt="Seagloré" 
    style={{ width: '120px', height: '32px', objectFit: 'cover' }} 
  />
</div>
  ...
  style={{ border: `1px solid ${scrolled ? '#cccccc' : 'white'}`, width: '230px' }}
    ...
    <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-8 md:px-16 pb-16">
          <p className="text-white/90 text-base italic tracking-wide mb-3 ">Ocean Couture, Documented</p>
          ...
          <p className="text-white/80 text-base tracking-widest uppercase mb-8  flex items-center gap-3">
            <span className="border-l border-white/50 pl-3">A Limited Digital Editorial Archive.</span>
          </p>
          <div className="flex gap-6">
            <button className="text-white text-xs font-bold tracking-widest uppercase underline underline-offset-4 hover:text-white/70 transition-colors" onClick={scrollToEditorial}>
              View The First Edition
            </button>
            <button className="text-white text-xs font-bold tracking-widest uppercase underline underline-offset-4 hover:text-white/70 transition-colors" onClick={scrollToArchive}>
              Enter The Archive
            </button>
          </div>
        </div>
      ...
      <section id="editorial-section" className="bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="px-10 md:px-16 py-16 flex flex-col justify-center font-bold space-y-8 bg-white">
            <div>
              <p className="text-sm tracking-widest uppercase font-bold text-gray-400 mb-4">Product Title</p>
              <h2 className="text-10xl md:text-6xl font-Inter Tight, sans-serif " style={{ color: '#c9a84c' }}>Season 0:</h2>
              <h2 className="text-10xl md:text-6xl font-Inter Tight, sans-serif font-black text-black ">Seafoam Birth</h2>
            </div>
            <div className="space-y-4 border-t border-gray-200 pt-6">
              <div className="flex justify-between">
                <span className="text-black-500 uppercase tracking-widest text-xs font-bold">Format</span>
                <span className="italic text-gray-700 text-sm">Digital Editorial</span>
              </div>
              <div className="flex justify-between">
                <span className="text-black-500 uppercase tracking-widest text-xs font-bold">Length</span>
                <span className="italic text-gray-700 text-sm">84 Pages</span>
              </div>
              <div className="flex justify-between">
                <span className="text-black-500 uppercase tracking-widest text-xs font-bold">Access</span>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button className="px-8 py-4 bg-black text-white text-xs tracking-widest uppercase hover:bg-gray-800 transition-colors" onClick={() => setShowAccessModal(true)}>
      ...
      <section className="py-20 px-6 md:px-16 lg:px-24 bg-white">
        <div className="text-center mb-12">
          ...
          <h3 className="text-2xl md:text-3xl font-serif italic text-black">"Water As Structure. Not Symbol."</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {['symbol1', 'symbol2', 'symbol3'].map(s => (
            <div key={s} className="aspect-square overflow-hidden bg-gray-100">
      ...
      <section className="py-24 px-6 md:px-16 lg:px-24 text-center" style={{ backgroundColor: '#ede8df' }}>
        <p className="text-xs tracking-widest uppercase text-black-500 font-bold mb-6">Seagloré Academy</p>
        ...
        <p className="text-xs tracking-widest uppercase text-black-500 leading-loose mb-10 font-bold">
      ...
      <section id="archive" className="py-20 px-6 md:px-16 lg:px-24 bg-white">
        <div className="flex justify-between items-start mb-12">
          ...
          <p className="text-xs text-gray-500 font-bold max-w-xs text-right tracking-widest uppercase leading-relaxed">
      ...
      <section className="bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="px-10 md:px-16 py-16 flex flex-col justify-center space-y-6" style={{ backgroundColor: '#dce8dc' }}>
            <div>
              <p className="text-sm tracking-widest uppercase text-black-600 mb-3 font-bold">Founder & Creative Director</p>
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight leading-tight" style={{ color: '#c9a84c', textDecoration: 'underline', textUnderlineOffset: '6px' }}>
                Sevil Velsha
              </h2>
            </div>
            ...
            <div className="space-y-1.5 text-xs tracking-widest uppercase text-black-600 pt-2">
      ...
      <section className="pt-16 pb-6 px-6 md:px-16 lg:px-24 bg-white">
        <h2 className="font-black uppercase leading-none mb-8 text-black" style={{ fontSize: 'clamp(4rem, 12vw, 9rem)', letterSpacing: '-0.02em' }}>
          Future<br />Editions
        </h2>
        <div className="flex justify-between items-center mb-6">
          <p className="text-sm font-bold tracking-widest uppercase text-black-500 leading-relaxed">
          ...
          <div className="border border-gray-200 bg-gray-200 px-4 py-2">
            <p className="text-xs tracking-widest uppercase font-bold text-black-600">Small Run. Slow Release.</p>
          </div>
        </div>
      ...
      <footer className="py-10 px-6 md:px-16 lg:px-24 bg-white">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="w-full md:w-1/2 space-y-3">
            <h4 className="text-20 font-bold-900 font-black uppercase tracking-widest text-black">Request Access</h4>
            <div className="flex items-end gap-4 border-b border-gray-400 pb-2">
              <input
                ...
                className="flex-1 text-sm bg-transparent focus:outline-none text-gray-500 placeholder-gray-400"
                style={{ letterSpacing: '0.02em' }}
              />
              <button
