    ...
    <div className="w-full overflow-x-hidden bg-white min-h-screen flex flex-col items-center font-serif">
      ...
      <div className={`fixed inset-0 z-[100] bg-[#3a414d]/80 backdrop-blur-sm flex items-center justify-center p-4 transition-opacity duration-500 ${showModal ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        <div className={`bg-white p-10 md:p-16 max-w-[600px] w-full shadow-2xl relative transform transition-transform duration-500 ${showModal ? 'translate-y-0' : 'translate-y-8'}`}>
          ...
          <form action="https://formspree.io/f/xlgpdovz" method="POST" onSubmit={handleFormSubmit} className="flex flex-col gap-8">
            <input
              type="text"
              required
      ...
      <div className="flex flex-col items-start relative w-full overflow-hidden">
        ...
        <nav className="absolute top-0 left-0 w-full h-[100px] z-50 flex items-center justify-between px-12 lg:px-16 bg-transparent">
          ...
          <div className="hidden md:flex gap-12 items-center">
            ...
            <button
              onClick={() => navigate('/')}
              className="text-[11px] tracking-[4px] uppercase cursor-pointer drop-shadow-md px-3 py-1.5 transition-all hover:opacity-80"
        ...
        {/* Hero Section */}
        <div id="hero" className="bg-[#f8f8f8] h-[calc(100vh-60px+72px)] min-h-[726px] overflow-hidden relative shrink-0 w-full">
          ...
          <div className="relative flex flex-col gap-12 h-full items-center justify-center w-full pt-16">
            ...
            <div className="flex gap-16 items-center animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-500">
              ...
              >
                <p className="font-normal text-[9px] tracking-[4px] uppercase text-[#2c2c2c]">ENTER THE ARCHIVE</p>
              </button>
              <button
                onClick={() => scrollToSection('special-project')}
                className="border-b border-[#2c2c2c]/50 pb-2 cursor-pointer hover:border-[#2c2c2c] transition-all"
              >
                <p className="font-normal text-[9px] tracking-[4px] uppercase text-[#2c2c2c]">OPEN EDITION I</p>
              </button>
            </div>
          </div>
        </div>
        ...
        {/* Ethos Section */}
        <div id="ethos" className="bg-white pt-16 lg:pt-20 pb-32 relative w-full flex justify-center">
          <div className="max-w-[1280px] w-full px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            <div className="flex flex-col gap-12">
              <div className="flex flex-col gap-4">
                <p className="font-normal text-[#e2b6a3] text-[11px] tracking-[4px] uppercase">Our Ethos</p>
        ...
        {/* Atelier Section */}
        <div id="atelier" className="bg-[#f6f2ef] py-32 relative w-full flex justify-center">
          <div className="max-w-[1280px] w-full px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="order-1 lg:order-2 flex flex-col gap-12">
              <div className="flex flex-col gap-4">
                <h2 className="font-normal leading-none text-[#3a414d] text-[72px] tracking-tight">SEAGLORÉ ATELIER</h2>
                <p className="italic font-normal text-[#e2b6a3] text-[14px] tracking-[4px] uppercase">Where couture is made slowly.</p>
              </div>
              <div className="flex flex-col gap-12">
                {[
              ...
              <div className="pt-8 border-t border-[#e2b6a3]/20 flex justify-between items-center">
                <p className="text-[#8a95a5] text-[12px] tracking-[2px] uppercase">Time is part of the design.</p>
                <div onClick={() => scrollToSection('collection')} className="flex items-center gap-2 cursor-pointer group">
                  <p className="font-medium text-[#3a414d] text-[12px] tracking-[4px] uppercase group-hover:opacity-70 transition-opacity">Enter the Archive</p>
        ...
        {/* Collection Section */}
        <div id="collection" className="bg-[#edfaff] py-32 w-full flex justify-center">
          <div className="max-w-[1280px] w-full px-12">
            <div className="flex justify-between items-end pb-12 border-b border-[#e2b6a3]/20 mb-16">
              <div className="flex flex-col gap-4">
                <p className="font-normal text-[#e2b6a3] text-[12px] tracking-[4px] uppercase">The Collection</p>
                <h2 className="font-medium text-[#3a414d] text-[60px] leading-none">Ocean Studies</h2>
                <p className="font-normal text-[#e2b6a3] text-[14px] tracking-[3px] uppercase">Limited works. No repetition.</p>
              </div>
            </div>
        ...
        <div id="special-project" className="bg-[#f4f2ea] py-32 relative w-full overflow-hidden flex justify-center">
        ...
        <footer id="contact" className="bg-white border-t border-[#e2b6a3]/20 w-full py-24 flex justify-center">
          <div className="max-w-[1280px] w-full px-12">
            ...
            <div className="border-t border-[#e2b6a3]/10 pt-12 flex justify-between items-center">
              <p className="text-[9px] text-[#8a95a5] tracking-[1px] uppercase">© 2026 SEAGLORÉ. ALL RIGHTS RESERVED.</p>
              <div className="flex gap-8">
