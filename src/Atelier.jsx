...
export default function App() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', overflowX: 'hidden', margin: 0, padding: 0 }}>
      ...
      <div className="flex flex-col w-full overflow-hidden" data-name="SEAGLORÉ">
        ...
        <nav className="absolute top-0 left-0 w-full h-[100px] z-50 flex items-center justify-between px-12 lg:px-16 bg-transparent">
          ...
          {/* Mobile hamburger — properly wired */}
          <button
        ...
        {/* Mobile Menu Overlay */}
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-[90] bg-[#3a414d] flex flex-col pt-24 px-10 pb-10">
            <button
            ...
            <nav className="flex flex-col gap-0">
              ...
              <button
                ...
                className="text-left text-[28px] tracking-[4px] uppercase py-6 mt-2"
                style={{ color: '#e2b6a3' }}
              >
                Request Showing
              </button>
        ...
        <div id="hero" className="bg-[#f8f8f8] h-screen overflow-hidden relative shrink-0 w-full" data-name="Section">
